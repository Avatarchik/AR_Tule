...
{
    public delegate void OnMarkerInOutChangeDelegate(Region_Capture rg);
    public event OnMarkerInOutChangeDelegate _OnMarkerInCB;
    public event OnMarkerInOutChangeDelegate _OnMarkerOutCB;


    public static string LayerName = "RenderCamera";
    ...
    public void StartInitialize(GameObject itObj)
    {
        ImageTarget = itObj;
