...
public class PointCloudRegognizer : DiscreteGestureRecognizer<PointCloudGesture>
{
    ...
    protected override bool CanBegin(PointCloudGesture gesture, FingerGestures.IFingerList touches)
    {
    ...
    protected override void ProcessCluster(FingerClusterManager.Cluster cluster)
    {
        ...
        PointCloudGesture gesture = MatchActiveGestureToCluster(cluster);
